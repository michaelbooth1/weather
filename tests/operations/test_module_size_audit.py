...
def test_current_warning_modules_have_complete_ownership_metadata_and_no_orphans():
    ...
    # 25 since 2026-09-04; the exact multi-year residual source stack moved
    # weather.calibration.multiyear_nwp_residual above the warning threshold.
    ...
    assert payload["warning_count"] == 25
