...
class TestStorageClassRegistry(unittest.TestCase):
    ...
    def test_representative_current_data_artifacts_are_classified(self):
        examples = {
            ...
            "data/backtest/model_market_skill_history.jsonl": CANONICAL_EVIDENCE,
            "data/backtest/model_market_skill_summary.json": OPERATOR_CACHE,
            "data/backtest/model_market_skill_report.md": OPERATOR_CACHE,
