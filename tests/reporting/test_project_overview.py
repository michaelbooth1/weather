...
@pytest.mark.parametrize("heading", ("Ordered next work", "Ordered non-live critical path", "Ordered critical path", "Critical path"))
@mock.patch("weather.reporting.roadmap.project_overview.subprocess.run")
def test_project_overview_uses_canonical_next_steps_and_ledger(tmp_git, tmp_path, heading):
