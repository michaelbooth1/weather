"""Single-market dashboard view for the Streamlit app."""
...
def render_single_market_page(market_id, live_refresh_seconds):
    ...
    def _render_trust_banner(market_id):
        try:
    ...
    _render_trust_banner(market_id)
