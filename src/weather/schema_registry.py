...
REGISTERED_SCHEMAS = (
    ...
    SchemaSpec(
        ...
        "weather.reporting.item134_forecast_profile_disposition",
        "active",
    ...
    SchemaSpec(
        ...
        "weather.reporting.forecast_smoke_gate",
        "active",
    ...
    SchemaSpec(
        ...
        "weather.reporting.forecast_smoke_slice_prep",
        "active",
    ...
    SchemaSpec(
        ...
        "weather.reporting.global_model_guidance_gate",
        "active",
    ...
    SchemaSpec(
        ...
        "weather.reporting.nbm_probabilistic_tmax_gate",
        "active",
    ...
    SchemaSpec(
        ...
        "weather.reporting.forecast_double_counting",
        "active",
    ...
    SchemaSpec(
        ...
        "weather.reporting.item135_cutoff_regime_disposition",
        "active",
    ...
    SchemaSpec(
        ...
        "weather.reporting.item136_source_state_disposition",
        "active",
    ...
    SchemaSpec(
        ...
        "weather.reporting.item138_weak_input_family_gate",
        "active",
    ...
    SchemaSpec(
        ...
        "weather.reporting.candidate_variant_replay_summary",
        "active",
    ...
    SchemaSpec(
        ...
        "weather.reporting.bottom_location_winner_centering",
        "active",
    ...
    SchemaSpec(
        ...
        "weather.reporting.exact_band_distance_zero_calibration",
        "active",
    ...
    SchemaSpec(
        ...
        "weather.reporting.current_max_trust_retrain_gate",
        "active",
    ...
    SchemaSpec(
        ...
        "weather.reporting.per_location_artifact_quarantine",
        "active",
    ...
    SchemaSpec(
        ...
        "weather.reporting.frozen_baseline_replay_trend",
        "active",
    ...
    SchemaSpec(
        ...
        "weather.reporting.pooled_f_retrain_location_gate",
        "active",
    ...
    SchemaSpec(
        ...
        "weather.reporting.serving_ordinal_smoothing_gate",
        "active",
    ...
    SchemaSpec(
        ...
        "weather.reporting.served_distribution_calibration_contract",
        "active",
    ...
    SchemaSpec(
        ...
        "weather.reporting.early_hour_positive_daily_first_gate",
        "active",
    ...
    SchemaSpec(
        ...
        "weather.reporting.item224_no_market_seattle_warm_support_repair",
        "active",
