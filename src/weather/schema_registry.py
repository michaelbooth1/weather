...
REGISTERED_SCHEMAS = (
    ...
    SchemaSpec(
        ...
        "reanalysis_synoptic_features_v0.2",
        "weather.sources.reanalysis_synoptic",
        "active",
        "Gated ERA5/reanalysis antecedent-state, soil, cloud, radiation, pressure, teleconnection, and static city-context feature sidecar.",
    ...
    SchemaSpec(
        ...
        "pooled_continuous_density_hgb_v0.1",
        "weather.calibration.pooled_feature_model",
        "active",
        "All-market canonical-F continuous-density candidate artifact.",
    ),
    ...
    SchemaSpec(
        ...
        "active",
        "Daily launcher status for paper-live-forward market-making runs.",
    ),
    SchemaSpec(
