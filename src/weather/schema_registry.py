...
REGISTERED_SCHEMAS = (
    ...
    SchemaSpec(
        ...
        "active",
        "Parsed numbered roadmap item inventory, active backlog report, and active-item docs lint.",
    ),
    SchemaSpec(
