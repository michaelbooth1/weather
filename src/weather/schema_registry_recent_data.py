...
RECENT_REGISTERED_SCHEMAS = (
    ...
    SchemaSpec(
        ...
        "weather.market.live_taker_canary",
        "active",
        "Self-hashed, secret-free, exact-release and exact-account reviewed scope for one tiny expiring capital campaign; never grants authority by itself.",
    ),
    SchemaSpec(
        "capital_canary_status",
        "capital_canary_status_v0.1",
        "weather.market.live_taker_canary",
        "active",
        "Atomic capital-canary authority, health, portfolio, risk, and append-only-ledger high-water projection.",
    ),
    SchemaSpec(
    ...
    SchemaSpec(
        "capital_canary_dashboard",
        "capital_canary_dashboard_v0.1",
        "weather.reporting.market.capital_canary_dashboard",
        "active",
        "Bounded read-only homepage projection of capital-canary status and recent audit evidence.",
    ),
    SchemaSpec(
