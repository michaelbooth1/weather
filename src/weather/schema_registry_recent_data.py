...
RECENT_REGISTERED_SCHEMAS = (
    ...
    SchemaSpec(
        "cold_archive_recovery_publication",
        "cold_archive_recovery_publication_v0.1",
        "weather.operations.cold_archive_recovery_publication",
        "active",
        "Workstation complete-recovery and verified metadata-custody handback.",
    ),
    SchemaSpec(
        "cold_archive_key_custody",
        "cold_archive_key_custody_v0.1",
        "weather.operations.cold_archive_recovery_publication",
        "active",
        "Owner confirmation of recovery-key storage outside both PCs; no key material.",
    ),
    SchemaSpec(
        "cold_archive_spool_inventory",
        "cold_archive_spool_inventory_v0.1",
        "weather.operations.cold_archive_spool_cleanup",
        "active",
        "Exact temporary archive payload identities bound to one completely restored archive.",
    ),
    SchemaSpec(
        "cold_archive_spool_cleanup",
        "cold_archive_spool_cleanup_v0.1",
        "weather.operations.cold_archive_spool_cleanup",
        "active",
        "Journaled removal of verified temporary archive payloads; original and remote counts stay separate.",
    ),
    SchemaSpec(
        "production_cold_archive_crypt_receipt",
        "production_cold_archive_crypt_receipt_v0.1",
        "weather.operations.bulk_cold_archive_crypt",
        "active",
        "Pinned production archive encryption proof retaining local source.",
    ),
    SchemaSpec(
        "production_cold_archive_restore_receipt",
        "production_cold_archive_restore_receipt_v0.1",
        "weather.operations.bulk_cold_archive_crypt",
        "active",
        "Independent ciphertext decryption and complete member restoration proof; no deletion authority.",
    ),
    SchemaSpec(
        "production_cold_archive_transport_receipt",
        "production_cold_archive_transport_receipt_v0.1",
        "weather.operations.production_cold_archive_transfer_core",
        "active",
        "Create-only private Drive transfer with independent ciphertext and metadata downloads.",
    ),
    SchemaSpec(
        "production_cold_archive_transfer_request",
        "production_cold_archive_transfer_request_v0.1",
        "weather.operations.production_cold_archive_transfer",
        "active",
        "Exact expiring host-bound encrypted archive transfer request.",
    ),
    SchemaSpec(
        "production_cold_archive_transfer_execution_receipt",
        "production_cold_archive_transfer_execution_receipt_v0.1",
        "weather.operations.production_cold_archive_transfer",
        "active",
