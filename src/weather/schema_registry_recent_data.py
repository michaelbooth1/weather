...
RECENT_REGISTERED_SCHEMAS = (
    ...
    SchemaSpec(
        "execution_tape_gap",
        "execution_tape_gap_v0.1",
        "weather.market.execution_tape_store",
        "active",
        "Append-only websocket dark-gap OPEN/CLOSED transition with reconnect duration.",
    ),
    SchemaSpec(
        "execution_tape_seed",
    ...
    SchemaSpec(
        "previous_runs_research_collection_plan",
        "previous_runs_research_collection_plan_v1",
        "weather.sources.previous_runs_research_collection",
        "active",
        "Outcome-blind request matrix frozen before the bounded multi-year Previous Runs provider collection.",
    ),
    SchemaSpec(
        "previous_runs_research_root_metadata",
        "previous_runs_research_root_metadata_v1",
        "weather.sources.previous_runs_research_collection",
        "active",
        "Self-hashed external-root binding for the immutable plan and exact source Git identity.",
    ),
    SchemaSpec(
        "previous_runs_research_response_headers",
        "previous_runs_research_response_headers_v1",
        "weather.sources.previous_runs_research_collection",
        "active",
        "Request-bound provider status, response headers, and retrieval-time evidence that makes no historical-availability claim.",
    ),
    SchemaSpec(
        "previous_runs_research_attempt_receipt",
        "previous_runs_research_attempt_receipt_v1",
        "weather.sources.previous_runs_research_collection",
        "active",
        "Append-only retained receipt for one failed, retryable, or terminal provider attempt.",
    ),
    SchemaSpec(
        "previous_runs_research_unit_receipt",
        "previous_runs_research_unit_receipt_v1",
        "weather.sources.previous_runs_research_collection",
        "active",
        "Content-addressed terminal receipt for one market-year-segment raw response and normalized projection.",
    ),
    SchemaSpec(
        "previous_runs_research_resume_state",
        "previous_runs_research_resume_state_v1",
        "weather.sources.previous_runs_research_collection",
        "active",
        "Atomic latest state plus append-only history for safe collection resumption without overwriting completed units.",
    ),
    SchemaSpec(
        "previous_runs_research_run_summary",
        "previous_runs_research_run_summary_v1",
        "weather.sources.previous_runs_research_collection",
        "active",
        "Bounded non-terminal collection result used when the overall runtime limit requires a later resume.",
    ),
    SchemaSpec(
        "previous_runs_research_corpus_manifest",
        "previous_runs_research_corpus_manifest_v1",
        "weather.sources.previous_runs_research_collection",
        "active",
        "Research-only terminal corpus disposition, complete denominator, coverage rollups, retries, and unit bindings.",
    ),
    SchemaSpec(
        "previous_runs_research_final_verification",
        "previous_runs_research_final_verification_v1",
        "weather.sources.previous_runs_research_collection",
        "active",
        "Independent terminal re-hash inventory over every retained plan, response, projection, receipt, and manifest.",
    ),
    SchemaSpec(
        "previous_runs_research_acl_proof",
        "previous_runs_research_acl_proof_v1",
        "scripts.ops.workstation_research_collection",
        "active",
        "Post-collection Windows ACL proof for the explicit CodexSandboxOffline write and delete denial.",
    ),
    SchemaSpec(
    ...
    SchemaSpec(
        "multiyear_nwp_residual_p0",
        "multiyear_nwp_residual_p0_v1",
        "weather.calibration.multiyear_nwp_residual",
        "active",
        "Read-only corpus rehash, outcome-support inventory, coverage, and ACL proof before or after the terminal residual experiment.",
    ),
    SchemaSpec(
        "multiyear_nwp_residual_design",
        "multiyear_nwp_residual_design_v1",
        "weather.calibration.multiyear_nwp_residual",
        "active",
        "Outcome-blind frozen feature, estimator, cohort, inference, and decision contract for the 2024-to-2025 residual information test.",
    ),
    SchemaSpec(
        "multiyear_nwp_residual_training",
        "multiyear_nwp_residual_training_v1",
        "weather.calibration.multiyear_nwp_residual",
        "active",
        "Two-model 2024 native-unit residual training receipt with exact feature and artifact bindings.",
    ),
    SchemaSpec(
        "multiyear_nwp_residual_model",
        "multiyear_nwp_residual_model_v1",
        "weather.calibration.multiyear_nwp_residual",
        "active",
        "Research-only serialized HistGradientBoostingRegressor arm bound to one frozen residual design and exact feature order.",
    ),
    SchemaSpec(
        "multiyear_nwp_residual_terminal_attempt",
        "multiyear_nwp_residual_terminal_attempt_v1",
        "weather.calibration.multiyear_nwp_residual",
        "active",
        "Create-only seal that spends the single authorized 2025 outcome-source evaluation before the source is opened.",
    ),
    SchemaSpec(
        "multiyear_nwp_residual_result",
        "multiyear_nwp_residual_result_v1",
        "weather.calibration.multiyear_nwp_residual",
        "active",
        "Research-only point-forecast result with native and Celsius-equivalent metrics, crossed uncertainty, power, MDE, and terminal decision.",
    ),
    SchemaSpec(
        "multiyear_nwp_residual_result_verification",
        "multiyear_nwp_residual_result_verification_v1",
        "weather.calibration.multiyear_nwp_residual",
        "active",
        "Deterministic result and bootstrap reproduction from the sealed evaluation record without reopening source outcomes or refitting models.",
    ),
    SchemaSpec(
        "multiyear_nwp_residual_external_transfer",
        "multiyear_nwp_residual_external_transfer_v1",
    ...
    SchemaSpec(
        ...
        "weather.calibration.multiyear_nwp_residual_external",
        "active",
        "Immutable no-refit external-secondary cohort, artifact, feature, inference, and non-confirmatory contract committed before 2026 outcome access.",
    ),
    SchemaSpec(
        "multiyear_nwp_residual_external_attempt",
        "multiyear_nwp_residual_external_attempt_v1",
        "weather.calibration.multiyear_nwp_residual_external",
        "active",
        "Create-only external-secondary attempt seal written before opening the selected 2026 WU outcome values.",
    ),
    SchemaSpec(
        "multiyear_nwp_residual_external_result",
        "multiyear_nwp_residual_external_result_v1",
        "weather.calibration.multiyear_nwp_residual_external",
        "active",
        "Separate pre-boundary and post-boundary no-refit metrics, crossed inference, support, integrity, and non-authorizing disposition.",
    ),
    SchemaSpec(
        "multiyear_nwp_residual_external_verification",
        "multiyear_nwp_residual_external_verification_v1",
        "weather.calibration.multiyear_nwp_residual_external",
        "active",
        "Deterministic external-secondary result and bootstrap reproduction from sealed records without source-outcome access or model fitting.",
    ),
    SchemaSpec(
        "multiyear_nwp_residual_external_completion_amendment",
        "multiyear_nwp_residual_external_completion_amendment_v1",
        "weather.calibration.multiyear_nwp_residual_external_completion",
        "active",
        "Immutable no-refit completion design binding the frozen models, old WU support, protected production export, separate provenance cohorts, and directional rule.",
    ),
    SchemaSpec(
        "multiyear_nwp_residual_external_completion_attempt",
        "multiyear_nwp_residual_external_completion_attempt_v1",
        "weather.calibration.multiyear_nwp_residual_external_completion",
        "active",
        "Create-only completion-attempt seal written and fsynced before either 2026 outcome source is parsed.",
    ),
    SchemaSpec(
        "multiyear_nwp_residual_external_completion_result",
        "multiyear_nwp_residual_external_completion_result_v1",
        "weather.calibration.multiyear_nwp_residual_external_completion",
        "active",
        "Separate pre-boundary and post-boundary no-refit completion metrics, crossed uncertainty, source accounting, and non-authorizing directional disposition.",
    ),
    SchemaSpec(
        "multiyear_nwp_residual_external_completion_verification",
        "multiyear_nwp_residual_external_completion_verification_v1",
        "weather.calibration.multiyear_nwp_residual_external_completion",
        "active",
        "Deterministic completion-result and crossed-bootstrap reproduction from sealed records without reopening outcomes or loading or fitting models.",
    ),
    SchemaSpec(
        "wu_outcome_gap_manifest",
        "wu_outcome_gap_manifest_v1",
        "weather.operations.wu_outcome_export_contract",
        "active",
        "Outcome-blind complete WU support matrix for a frozen market/date cohort, including source identities and latest-revision row-count disposition.",
    ),
    SchemaSpec(
        "wu_outcome_production_export_spec",
        "wu_outcome_production_export_spec_v1",
        "weather.operations.wu_outcome_export_contract",
        "active",
        "Fail-closed create-only contract for a bounded authoritative WU settlement export that has no production entry point yet.",
    ),
    SchemaSpec(
        "wu_outcome_production_export_manifest",
        "wu_outcome_production_export_manifest_v1",
        "weather.operations.wu_outcome_export_contract",
        "active",
        "Self-hashed manifest for a future two-file WU settlement export with source pre/post hashes and destination ACL proof.",
    ),
    SchemaSpec(
        "wu_outcome_production_export_row",
        "wu_outcome_production_export_row_v1",
        "weather.operations.wu_outcome_export_contract",
        "active",
        "One native-unit authoritative WU settlement row for an exact requested market/date gap.",
    ),
    SchemaSpec(
        "wu_outcome_production_export_validation",
        "wu_outcome_production_export_validation_v1",
        "weather.operations.wu_outcome_export_contract",
        "active",
        "Outcome-silent verification receipt for the future bounded WU settlement export.",
    ),
)
