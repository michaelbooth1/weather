...
RECENT_REGISTERED_SCHEMAS = (
    ...
    SchemaSpec(
        "calendar_residual_replication_p0",
        "calendar_residual_replication_p0_v1",
        "weather.calibration.calendar_residual_replication",
        "active",
        "Read-only two-corpus rehash, outcome-support inventory, coverage, and ACL proof before or after the calendar residual replication.",
    ),
    SchemaSpec(
        "calendar_residual_replication_design",
        "calendar_residual_replication_design_v1",
        "weather.calibration.calendar_residual_replication",
        "active",
        "Outcome-blind frozen 2024 training and untouched outside-window 2025 evaluation contract for the residual replication.",
    ),
    SchemaSpec(
        "calendar_residual_replication_training",
        "calendar_residual_replication_training_v1",
        "weather.calibration.calendar_residual_replication",
        "active",
        "Exact two-fit 2024 calendar-extended residual training receipt with immutable model and cohort bindings.",
    ),
    SchemaSpec(
        "calendar_residual_replication_terminal_attempt",
        "calendar_residual_replication_terminal_attempt_v1",
        "weather.calibration.calendar_residual_replication",
        "active",
        "Create-only attempt that spends the sole authorized untouched outside-window 2025 outcome evaluation.",
    ),
    SchemaSpec(
        "calendar_residual_replication_result",
        "calendar_residual_replication_result_v1",
        "weather.calibration.calendar_residual_replication",
        "active",
        "Separated seasonal and combined research-only point-forecast replication metrics, inference, and bounded disposition.",
    ),
    SchemaSpec(
        "calendar_residual_replication_result_verification",
        "calendar_residual_replication_result_verification_v1",
        "weather.calibration.calendar_residual_replication",
        "active",
        "Deterministic calendar-replication result and bootstrap reproduction without source-outcome access or model refitting.",
    ),
)
