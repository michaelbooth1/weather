...
def base_order_row(input_row, run_id, target_date, now, config, config_hash, strategy=None, experiment_id=None):
    ...
    return {
        ...
        "correlated_regime_notional_before_usdc": 0.0,
        "correlated_regime_notional_after_usdc": 0.0,
        "correlated_regime_signed_notional_before_usdc": 0.0,
        "correlated_regime_signed_notional_after_usdc": 0.0,
        "correlated_regime_joint_stress_loss_before_usdc": 0.0,
        "correlated_regime_joint_stress_loss_after_usdc": 0.0,
        "correlated_regime_notional_remaining_usdc": None,
        "correlated_regime_joint_loss_remaining_usdc": None,
        "correlated_regime_notional_cap_usdc": 0.0,
        "correlated_regime_joint_loss_cap_usdc": 0.0,
        "correlated_regime_cap_breached": False,
