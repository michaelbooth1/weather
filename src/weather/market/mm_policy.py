...
QUOTE_COLUMNS = [
    ...
    "model_variant_artifact_path",
    "model_variant_artifact_hash",
    "model_variant_postprocess_config_hash",
    "model_variant_feature_schema",
...
def _base_output(row, config, now, reason_code, reason_detail):
    ...
    output = {
        ...
        "served_fair_probability": maybe_float(row.get("served_fair_probability")) if row.get("served_fair_probability") not in (None, "") else fair,
        ...
        "model_variant_basket_id": row.get("model_variant_basket_id") or "maker_default_v0",
        "model_variant_basket_size": row.get("model_variant_basket_size") or 1,
        "model_variant_probability_source": row.get("model_variant_probability_source") or "served_fair_probability",
        "model_variant_prediction_at_utc": row.get("model_variant_prediction_at_utc") or row.get("captured_at_utc") or now.isoformat(),
        "model_variant_artifact_path": row.get("model_variant_artifact_path") or "",
        "model_variant_artifact_hash": row.get("model_variant_artifact_hash") or "",
        "model_variant_postprocess_config_hash": row.get("model_variant_postprocess_config_hash") or "",
        "model_variant_feature_schema": row.get("model_variant_feature_schema") or "",
        "model_variant_runtime_identity": row.get("model_variant_runtime_identity") or "",
