...
ARTIFACT_FAMILIES = (
    ...
    ArtifactFamilyClassification(
        "model_market_skill_revision_history",
        "reporting/scorecards",
        CANONICAL_EVIDENCE,
        ("backtest/model_market_skill_history.jsonl",),
        "permanent_reported_skill_revision_history",
        "not safely reproducible as originally reported after code and settlement revisions",
        "canonical_evidence_review_gate",
        True,
        examples=("data/backtest/model_market_skill_history.jsonl",),
        notes="Append-only corrections supersede prior records; prior reported revisions remain evidence.",
    ),
    ArtifactFamilyClassification(
    ...
    ArtifactFamilyClassification(
        ...
        (
            ...
            "backtest/model_market_skill_summary.json",
            "ops/**/*.json",
        ),
