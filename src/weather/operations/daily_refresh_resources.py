...
STAGE_A_STEP_RESOURCE_POLICIES = {
    ...
    "public_wu_settlement_restore": {"isolation": "in_process", "rationale": "one target day with request timeout"},
    ...
    "taker_finalization_watchdog": {"isolation": "in_process", "rationale": "bounded active-run finalization"},
    ...
    "maker_paper_score": _budget(60, 4096, 3072, "latest-14-run maker scoring under 512 MiB input preflight"),
