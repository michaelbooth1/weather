...
REGISTERED_SCHEMAS = (
    ...
    SchemaSpec(
        ...
        "active",
        "Evidence for one minimum-notional International post-only order and its dead-man or cancel-all lifecycle.",
        supersedes=("mm_live_lifecycle_probe_v0.1",),
    ),
    SchemaSpec(
    ...
    SchemaSpec(
        ...
        "weather.market.mm_live_lifecycle_probe",
        "active",
        "Append-only flushed event journal for authorization, placement, observation, cancellation, cleanup, and failure of the first International live mutation.",
    ),
    SchemaSpec(
    ...
    SchemaSpec(
        ...
        "active",
        "International wallet, authenticated account, non-posting signed-order topology, market, stream, current heartbeat acknowledgment, cancellation, and secret-hygiene proof before the first lifecycle order.",
        supersedes=("mm_platform_bootstrap_v0.2",),
    ),
    SchemaSpec(
    ...
    SchemaSpec(
        ...
        supersedes=("mm_stage1_lifecycle_bundle_v0.1",),
    ),
    SchemaSpec(
    ...
    SchemaSpec(
        ...
        "active",
        "Strict public input contract for deterministic generation of no-argument International Stage 0, cancel-all, or dead-man wrappers with credential-reference and predecessor lineage; contains hashes and paths but no credential values.",
        supersedes=("international_live_fixed_scope_seal_spec_v0.1",),
    ),
    SchemaSpec(
    ...
    SchemaSpec(
        ...
        "weather.operations.international_live_wrapper_sealer",
        "active",
        "Secret-free terminal wrapper receipt with separate order-submit and authenticated-write facts for Stage 0, cancel-all, or dead-man execution.",
        supersedes=("international_live_fixed_scope_execution_v0.3",),
    ),
    SchemaSpec(
    ...
    SchemaSpec(
        ...
        "weather.operations.international_live_wrapper_sealer",
        "active",
        "Read-only public inventory of production Git, template, and source hashes used to author a reviewed fixed-scope seal spec.",
    ),
    SchemaSpec(
    ...
    SchemaSpec(
        ...
        "active",
        "Independently raw-hash-reviewed non-raisable Stage 0 or sequenced Stage 1 scope consumed with only a fixed-inbox fresh candidate and a 120-second envelope.",
        supersedes=("international_live_fixed_session_manifest_v0.1",),
    ),
    SchemaSpec(
    ...
    SchemaSpec(
        ...
        "active",
        "International live-pilot wallet identity, heartbeat, fee, reward, and API-semantics verification evidence.",
