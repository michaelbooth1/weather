...
REGISTERED_SCHEMAS = (
    ...
    SchemaSpec(
        ...
        "active",
        "Strict public input contract for deterministic generation of one no-argument International Stage 0 or Stage 1 cancel-all wrapper; contains hashes and paths but no credential values.",
    ),
    SchemaSpec(
        ...
        "weather.operations.international_live_wrapper_sealer",
        "active",
        "Immutable secret-free seal receipt binding one generated wrapper and launcher to exact production, source, input, scope, TTL, output, and hardening evidence.",
    ),
    SchemaSpec(
        ...
        "weather.operations.international_live_wrapper_sealer",
        "active",
        "Secret-free terminal wrapper receipt for one fixed-scope Stage 0 or Stage 1 cancel-all process.",
    ),
    SchemaSpec(
    ...
    SchemaSpec(
        ...
        "active",
        "Pre-reviewed non-raisable Stage 0 or Stage 1 session scope consumed with only a fresh candidate.",
    ),
    SchemaSpec(
        ...
        "weather.operations.international_live_session_runner",
        "active",
        "Public receipt binding fresh-candidate copy, deterministic seal, and imminent fixed launcher invocation.",
    ),
    SchemaSpec(
        ...
        "weather.operations.international_live_session_runner",
        "active",
        "Terminal public receipt for one fixed session launcher process.",
    ),
    SchemaSpec(
