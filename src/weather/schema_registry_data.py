...
REGISTERED_SCHEMAS = (
    ...
    SchemaSpec(
        "mm_live_stage2_session_envelope",
        "mm_live_stage2_session_envelope_v0.2",
        "weather.market.mm_live_stage2",
        "active",
        "One-market, one-submit International maker-session authorization bound to current platform evidence, an explicitly profiled source quote, public capture, wallet state, and non-raisable risk ceilings.",
    ),
    SchemaSpec(
        "mm_live_stage2_paper_counterfactual",
        "mm_live_stage2_paper_counterfactual_v0.2",
        "weather.market.mm_live_stage2",
        "active",
        "Retained JSON manifest binding the exact current paper-live-forward treatment used by either the ordinary model lane or the bounded market-harvest Stage 2 successor.",
    ),
    SchemaSpec(
        "mm_live_stage2_session_journal",
        "mm_live_stage2_session_journal_v0.1",
        "weather.market.mm_live_stage2",
        "active",
        "Append-only redacted evidence for one bounded Stage 2 post-only BUY lifecycle and final account reconciliation.",
    ),
    SchemaSpec(
        "mm_live_stage2_session_result",
        "mm_live_stage2_session_result_v0.1",
        "weather.market.mm_live_stage2",
        "active",
        "Bounded Stage 2 lifecycle result with authoritative maker fills, exact positions and collateral, zero open orders, and unproven rebates excluded from economic acceptance.",
    ),
    SchemaSpec(
