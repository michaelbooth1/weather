...
REGISTERED_SCHEMAS = (
    ...
    SchemaSpec(
        "mm_liquidity_earnings_capture",
        "mm_liquidity_earnings_capture_v0.1",
        "weather.market.mm_liquidity_earnings_capture",
        "active",
        "Bounded read-only daily earnings request receipts and capture disposition; no paid attribution.",
    ),
    SchemaSpec(
    ...
    SchemaSpec(
        ...
        "weather.market.mm_live_bootstrap",
        "legacy",
        "Bootstrap before Stage 0 stopped treating a pre-bound positive candidate fee as heartbeat/cancel-all eligibility.",
    ),
    SchemaSpec(
    ...
    SchemaSpec(
        ...
        "active",
        "Stage 2/paper-only International quote-economics candidate binding an exact no-network substrate preflight, human-accepted economics baseline, no-drift report, candidate/date-specific operator acknowledgment, current paper quote, and current CLOB book; it has no Stage 0 or Stage 1 authority and is never trading authorization.",
    ...
    SchemaSpec(
        "mm_live_stage0_scope_plan",
        "mm_live_stage0_scope_plan_v0.1",
        "weather.market.mm_live_stage0_scope",
        "active",
        "Fresh, secret-free, non-authorizing International Stage 0 market scope binding a plan-time current Gamma active event/condition/ordered-token comparison plus current structural CLOB evidence, without quote-economics or paper-quote eligibility gates.",
    ),
    SchemaSpec(
        "mm_live_stage1_lifecycle_plan",
        "mm_live_stage1_lifecycle_plan_v0.1",
        "weather.market.mm_live_stage1_lifecycle_plan",
        "active",
        "Fresh, secret-free, non-authorizing International Stage 1 lifecycle plan binding an exact Stage 0 condition/token scope, generated metadata rechecked against current Gamma active event/condition/ordered-token identity, current public book, official tick/neg-risk/fee rules, and one minimum-size minimum-tick nonmarketable post-only BUY within the 10 pUSD pilot cap; quote economics are not eligibility gates.",
    ),
    SchemaSpec(
    ...
    SchemaSpec(
        ...
        "active",
        "Strict stage-specific public input contract for deterministic no-argument International wrappers: Stage 0 binds identity, credential references, generated event metadata, and structural scope evidence; Stage 1 binds the same generated event metadata, a lifecycle-safety plan, and predecessor evidence without quote-economics gates; contains no credential values.",
        supersedes=("international_live_fixed_scope_seal_spec_v0.4",),
    ),
    SchemaSpec(
        "international_live_fixed_scope_seal_spec_v0_4_legacy",
        "international_live_fixed_scope_seal_spec_v0.4",
        "weather.operations.international_live_wrapper_sealer",
        "legacy",
        "Fixed-scope seal specification before Stage 0 structural scope and Stage 1 lifecycle-plan/event-metadata inputs were separated from the retired Stage 1 quote-economics path.",
    ),
    SchemaSpec(
    ...
    SchemaSpec(
        ...
        "active",
        "Independently raw-hash-reviewed stage-specific scope binding an exact execution host: Stage 0 carries generated event metadata and structural scope evidence, while Stage 1 carries the same event metadata plus a direct lifecycle-safety plan and predecessor evidence within a profile-fixed 120- or 240-second envelope; quote economics are outside both stages.",
        supersedes=("international_live_fixed_session_manifest_v0.4",),
    ),
    SchemaSpec(
        "international_live_fixed_session_manifest_v0_4_legacy",
        "international_live_fixed_session_manifest_v0.4",
        "weather.operations.international_live_session_runner",
        "legacy",
        "Fixed session manifest before Stage 0 structural scope and Stage 1 lifecycle-plan/event-metadata inputs were separated from the retired Stage 1 quote-economics path.",
    ),
    SchemaSpec(
    ...
    SchemaSpec(
        ...
        "active",
        "Secret-free receipt for exclusive staging and exact-host fixed-session publication from a reviewed discovery plan: Stage 0 stages structural scope plus generated event metadata, and Stage 1 stages lifecycle safety plus the same bound event metadata without quote-economics inputs.",
        supersedes=("international_live_session_manifest_build_v0.3",),
    ),
    SchemaSpec(
        "international_live_session_manifest_build_v0_3_legacy",
        "international_live_session_manifest_build_v0.3",
        "weather.operations.international_live_session_launcher_sealer",
        "legacy",
        "Manifest-build receipt before Stage 0 structural scope and Stage 1 lifecycle-plan/event-metadata inputs were separated from the retired Stage 1 quote-economics path.",
    ),
    SchemaSpec(
    ...
    SchemaSpec("mm_policy", "mm_policy_v0.3", "weather.market.mm_policy", "active", supersedes=("mm_policy_v0.1", "mm_policy_v0.2")),
    SchemaSpec("mm_policy_legacy", "mm_policy_v0.1", "weather.market.mm_policy", "legacy"),
    SchemaSpec("mm_policy_prior", "mm_policy_v0.2", "weather.market.mm_policy", "legacy"),
