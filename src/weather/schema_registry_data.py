...
REGISTERED_SCHEMAS = (
    ...
    SchemaSpec(
        ...
        "weather.operations.international_live_wrapper_sealer",
        "active",
        "Secret-free terminal wrapper receipt for one fixed-scope Stage 0, Stage 1 cancel-all, or Stage 1 dead-man process with phase, credential, mutation, wrapper, and artifact evidence.",
        supersedes=("international_live_fixed_scope_execution_v0.2",),
    ),
    SchemaSpec(
    ...
    SchemaSpec(
        ...
        "weather.operations.international_live_session_runner",
        "active",
        "Terminal public receipt binding run intent, manifest, composition, seal, wrapper, launcher, child execution, teardown, mutation, and credential facts.",
        supersedes=("international_live_session_run_v0.1",),
    ),
    SchemaSpec(
