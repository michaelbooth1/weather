...
REGISTERED_SCHEMAS = (
    ...
    SchemaSpec(
        "polymarket_geoblock",
        "polymarket_geoblock_v0.1",
        "weather.market.mm_geoblock",
        "active",
        "Fresh, IP-redacted physical eligibility response from the official International Polymarket geoblock endpoint.",
    ),
    SchemaSpec(
        ...
        "active",
        "Public International host, SDK, fresh official physical geoblock proof, no-circumvention confirmation, signature, funder, isolation, and wallet-cap manifest used only to construct the client that collects Stage 0 evidence.",
    ),
    SchemaSpec(
    ...
    SchemaSpec(
        ...
        "active",
        "International live-pilot physical eligibility, wallet identity, heartbeat, fee, reward, and API-semantics verification evidence.",
