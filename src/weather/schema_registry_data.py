...
REGISTERED_SCHEMAS = (
    ...
    SchemaSpec(
        ...
        "active",
        "Fresh public International weather-market candidate binding an exact human-accepted economics baseline, no-drift report, candidate/date-specific operator acknowledgment, current paper-only quote, and current CLOB book; never trading authorization.",
        supersedes=("mm_live_market_candidate_plan_v0.2",),
    ),
    SchemaSpec(
    ...
    SchemaSpec(
        ...
        "active",
        "Strict public input contract for deterministic no-argument International wrappers with credential, predecessor, and exact accepted-economics/no-drift/operator-acknowledgment bindings; contains no credential values.",
        supersedes=("international_live_fixed_scope_seal_spec_v0.2",),
    ),
    SchemaSpec(
    ...
    SchemaSpec(
        ...
        "weather.operations.international_live_wrapper_sealer",
        "active",
        "Immutable secret-free seal receipt binding one generated wrapper and launcher to exact production, source, SDK, credential-reference, predecessor, scope, TTL, output, and hardening evidence.",
        supersedes=("international_live_fixed_scope_seal_v0.2",),
    ),
    SchemaSpec(
    ...
    SchemaSpec(
        ...
        "weather.operations.international_live_wrapper_sealer",
        "active",
        "Secret-free terminal wrapper receipt with separate order-submit and authenticated-write facts plus content-bound precredential and submit-adjacent geographic eligibility evidence.",
        supersedes=("international_live_fixed_scope_execution_v0.4",),
    ),
    SchemaSpec(
    ...
    SchemaSpec(
        ...
        "weather.operations.international_live_wrapper_sealer",
        "active",
        "Read-only public inventory of production Git, bounded live-remote master equality, template, and source hashes used to author a reviewed fixed-scope seal spec.",
        supersedes=("international_live_fixed_scope_inventory_v0.1",),
    ),
    SchemaSpec(
    ...
    SchemaSpec(
        ...
        "active",
        "Independently raw-hash-reviewed Stage 0 or sequenced Stage 1 scope binding exact accepted economics, no-drift, and candidate/date-specific informed acceptance evidence within a 120-second envelope.",
        supersedes=("international_live_fixed_session_manifest_v0.2",),
    ),
    SchemaSpec(
    ...
    SchemaSpec(
        ...
        "active",
        "Secret-free receipt for exclusive staging and fixed-session publication including exact accepted economics and no-drift evidence from a reviewed discovery plan.",
        supersedes=("international_live_session_manifest_build_v0.1",),
    ),
    SchemaSpec(
    ...
    SchemaSpec(
        ...
        "weather.operations.international_live_session_runner",
        "active",
        "Terminal public receipt binding complete launch lineage, teardown, credential use, order-submit facts, and authenticated exchange writes.",
        supersedes=("international_live_session_run_v0.2",),
    ),
    SchemaSpec(
