...
REGISTERED_SCHEMAS = (
    ...
    SchemaSpec(
        "daily_refresh_promotion_corpus_binding",
        "daily_refresh_promotion_corpus_binding_v0.1",
        "weather.operations.daily_refresh_corpus_binding",
        "active",
        "Exact path, byte-size, SHA-256, manifest-schema, corpus-hash, and producer-run receipt for a scheduled promotion corpus.",
    ),
    SchemaSpec(
        "daily_refresh_resume_source",
        "daily_refresh_resume_source_v0.1",
        "weather.operations.daily_refresh_corpus_binding",
        "active",
        "Stable status-ledger identity and SHA-256 provenance carried into a resumed daily-refresh run.",
    ),
    SchemaSpec(
    ...
    SchemaSpec(
        ...
        "active",
        "Physical-weather feature-family lineage, missingness, active-column, isolated replay, validated settlement-slice support, byte-bound upstream inputs, and promotion-authorization ratchet.",
        supersedes=("physical_feature_family_ratchet_v0.1",),
        migration_notes="Operational promotion consumers must reject v0.1 because it did not bind source-inventory and source-ablation authorization contracts.",
    ),
    SchemaSpec(
        "physical_feature_family_ratchet_legacy",
        "physical_feature_family_ratchet_v0.1",
        "weather.reporting.source_gates.physical_feature_family_ratchet",
        "legacy",
        "Legacy ratchet without input-authorization binding.",
    ),
    SchemaSpec(
    ...
    SchemaSpec(
        ...
        "active",
        "Settlement-scored operational source-family knockout replay with sealed corpus/splits, recomputable paired inference, stable input receipts, verified model binding, and explicit promotion-preflight evidence authorization.",
        supersedes=("source_family_ablation_v0.1",),
        migration_notes="Operational consumers reject v0.1 because it lacks affirmative research-boundary authorization; v0.2 remains a separate research-only schema, and loose/default replay now publishes v0.2 rather than v0.3.",
    ),
    SchemaSpec(
        "source_family_ablation_legacy",
        "source_family_ablation_v0.1",
        "weather.backtesting.replay_ablation",
        "legacy",
        "Legacy source-family ablation without explicit research-boundary authorization.",
    ),
    SchemaSpec(
        ...
        "active",
        "Weather-input family inventory with fail-closed byte-bound operational ablation authorization, lineage, train/serve parity, missingness, and derived promotion decisions.",
        supersedes=("source_family_inventory_v0.1",),
        migration_notes="Operational consumers must reject v0.1 inventories because they lack research-ablation provenance fencing.",
    ),
    SchemaSpec(
        "source_family_inventory_legacy",
        "source_family_inventory_v0.1",
        "weather.reporting.source_gates.source_family_inventory",
        "legacy",
        "Legacy inventory without research-ablation provenance fencing.",
    ),
    ...
    SchemaSpec(
        "mm_known_edge_map",
        "mm_known_edge_map_v0.2",
        "weather.market.mm_paper",
        "active",
        "Detached known-edge research/diagnostic map; non-authorizing for runtime edge or serving permission.",
    ),
    ...
    SchemaSpec(
        "promotion_corpus",
        "promotion_corpus_v0.2",
        "weather.reporting.promotion.promotion_corpus",
        "active",
        "Operational promotion corpus with a schema-separated boundary from derived research panels.",
        supersedes=("promotion_corpus_v0.1",),
    ),
    SchemaSpec(
        "promotion_corpus_v0_1_legacy",
        "promotion_corpus_v0.1",
        "weather.reporting.promotion.promotion_corpus",
        "legacy",
        "Legacy corpus envelope retained only for exact-hash historical research replay.",
    ),
    ...
    SchemaSpec(
        ...
        "weather.reporting.promotion.promotion_refresh",
        "active",
        "Detached per-market promotion recommendation projection; non-authorizing for serving or release.",
    ),
    SchemaSpec(
