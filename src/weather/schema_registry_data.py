...
REGISTERED_SCHEMAS = (
    ...
    SchemaSpec(
        "mm_exchange_adapter",
        "mm_exchange_adapter_v0.3",
        "weather.market.mm_exchange",
        "active",
        "International exchange diagnostics and cash reconciliation with explicitly matched incentive payments; accrued incentives are not wallet income.",
        supersedes=("mm_exchange_adapter_v0.2", "mm_exchange_adapter_v0.1"),
    ),
    SchemaSpec("mm_exchange_adapter_accrual_legacy", "mm_exchange_adapter_v0.2", "weather.market.mm_exchange", "legacy"),
    SchemaSpec("mm_incentive_payment_evidence", "mm_incentive_payment_evidence_v0.1", "weather.market.mm_incentive_payments", "active",
               "Normalized exact-account/asset/date incentive queries, accruals, distributions and referenced wallet transfers."),
    SchemaSpec("mm_incentive_payment_reconciliation", "mm_incentive_payment_reconciliation_v0.1", "weather.market.mm_incentive_payments", "active",
               "Pure supplied-evidence attribution of maker rebates and liquidity rewards to unique confirmed wallet transfers."),
    SchemaSpec(
