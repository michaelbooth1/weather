...
REGISTERED_SCHEMAS = (
    ...
    SchemaSpec(
        ...
        "active",
        "One-market, one-submit International maker-session authorization bound to current platform, live and paper quotes, public capture, wallet, and non-raisable risk ceilings.",
    ),
    SchemaSpec(
        ...
        "weather.market.mm_live_stage2",
        "active",
        "Retained JSON manifest binding the exact current paper-live-forward quote treatment frozen before one Stage 2 submit.",
    ),
    SchemaSpec(
