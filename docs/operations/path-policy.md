...
`<resolved repo_root>/.e/<8 manifest-hash characters><full UUID hex>`; that run
root is itself the workspace (reconciled 2026-09-20 with the reliability
executor repair, which owns the layout). This compact,
