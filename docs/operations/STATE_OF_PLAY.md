...
| Storage | The selected July 16-31 metadata totals 5,584 files / 111,275,511,800 historically allocated bytes; this is a candidate estimate, with zero new archive reclaim. Consumer closure remains open: historical replay, Parquet provenance and settled-folder discovery need explicit off-site availability handling. Separate bounded upload/download jobs passed workstation checks; consumer availability remains unresolved. [Item 325](../roadmap/items/item-325-tiered-data-retention-and-verified-archive-offload.md#september-9-production-chunk-transfer-qualification) owns the current evidence and limits. |
...
1. Finish explicit off-site history
