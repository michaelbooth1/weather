...
| Off-site qualification | Catalog and historical-reader source dcf714a4aa27eb68c2c51ca4682b5df8c820a291 is published in [draft PR 45](https://github.com/michaelbooth1/weather/pull/45), stacked on queued PR 44. CI 662 passed 5,072 tests but failed one schema-identifier audit; the repair and new native cache cleanup passed 98 workstation checks. Exact-head CI remains required. Private Drive connectivity has an 86-byte synthetic roundtrip only. No production archive transfer, restore or reclaim is proved. [Item 325](../roadmap/items/item-325-tiered-data-retention-and-verified-archive-offload.md) binds receipts. |
