...
| Capture | September 7 snapshot collection failed physical-memory admission after the 09:19 clean iteration. Stopping Windows drive optimization and restarting the oversized desktop shell restored a clean iteration at 10:10:15 with zero consecutive errors and over 5 GiB free physical RAM. CLOB, observation and public execution collection remained active. See the [incident and repair record](capture-memory-pressure-2026-09-07.md); the lost interval is not reconstructed. |
