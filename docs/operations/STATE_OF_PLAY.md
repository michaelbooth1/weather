...
| Audit repairs | Item 330 records the signed-band, quote-age, research-override, monitor and bounded-discovery repairs, plus exact resolution-text retention and per-file atomic publication. Qualification is in progress on the stacked audit-fixes topic; Git/CI own its final tip. Full paired configuration and settlement-source equivalence remain open. No production adoption is implied. |
