...
1. **Informed maker foundation (owner 2026-09-25):** model -> fair value -> domain-neutral maker core with plugins (weather now,
   YouTube views next); [design](informed-maker-design-2026-09-25.md) approved; Phase 0 = handoff 110a. RE-1 paused; owner may still run `collect-evidence` (attempts 5-11).
