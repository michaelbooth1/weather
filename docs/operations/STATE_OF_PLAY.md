...
confirmed attendance and physical eligibility, and explicitly requested a code
fix to use the existing wallet while preserving that allocation and the 10 pUSD
order limit. Continue preparation without repeating wallet/authorization
questions. The operator executes the reviewed attended launchers; the coding
...
| Today's path | Use the named portable-only exception after exact source/ref/host qualification. The owner rejected a new wallet and approved an explicit 100 pUSD test allocation on the existing wallet; reported cash is 275.48 pUSD. The repair is on `codex/live-test-capital-allocation-20260906`, stacked on `e82dd916a842ee8d011f9d09464978d956ab3a46`. Qualification and portable adoption remain pending. [Item 67](../roadmap/items/item-67-authenticated-exchange-adapter-and-mm-2-pilot-harness.md#2026-09-06-first-stage-0-failure-and-existing-wallet-allocation-repair) owns evidence and acceptance. |
...
1. Finish regression checks and complete-source review of the existing-wallet
   allocation repair; publish it and require exact-head CI before updating the
   named authorized portable topic and clean clone. Preserve production configs.
