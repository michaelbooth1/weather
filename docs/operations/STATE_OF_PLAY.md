...
| Storage | September 7 14:32 had about 27.0 GiB free. Both scheduled CLOB tiering jobs succeeded that morning and reported 15.1 GiB reclaimed. The [bounded cache compression lane](replay-cache-compression.md) now binds apply to a reviewed plan and has native launcher/failure qualification under [item 325](../roadmap/items/item-325-tiered-data-retention-and-verified-archive-offload.md). The initial apply command is superseded; the production pilot and measured savings remain open. At 14:40, commit was 78%, above the 70% admission ceiling. No project files were deleted or compressed by this work. |
...
| Storage | September 8 lossless local tiering retained the September 7 tapes in gzip form and reduced file lengths by 16.04 GiB. Free space reached 21.4 GiB after the 06:00 job, was 20.2 GiB at 08:03; sustained storage pressure remains unresolved. [Item 325](../roadmap/items/item-325-tiered-data-retention-and-verified-archive-offload.md#2026-09-08-overnight-local-tiering) owns exact bytes and receipts. The separate replay-cache pilot remains unexecuted because resource admission fails. The mirror is still paused and no new off-site restore proof is established. |
