...
3. Obtain the canonical roll verdict there, complete exact-tip CI and owner
   review on draft PR #3 under the operator's explicit Git authority, then use
