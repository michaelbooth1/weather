...
Stage 2 build with the corrected rules) and `2026-09-83b` (finish the parser repair; reuse the held NBM bulletin).
...
5. Workstation: mission `2026-09-83b` (Forecast lead row). Production, in a heavy window: the exact
