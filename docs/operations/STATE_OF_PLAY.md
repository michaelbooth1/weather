...
| Storage | The September 8 cold-snapshot pilot passed and recovered 39.5 MiB. Two expansion files have another 74.6 MiB of per-file hash-verified savings, but their batch failed the unchanged 70% commit gate; post-partial inventory also remains blocked. C: had 16.95 GiB free at about 13:05. Compression is paused with all children torn down; the 120 GiB newly reclaimed / 100 GiB free target remains open. [Item 325](../roadmap/items/item-325-tiered-data-retention-and-verified-archive-offload.md#production-pilot-and-resource-limited-expansion-september-8) owns exact receipts and resume requirements. Earlier overnight tiering does not count toward this target. |
