...
| Storage | September 8 owner-approved app/helper cleanup restored memory headroom (57.2% commit at 13:42) and storage recovery resumed. Two pilots passed; two stopped batches contain additional per-file verified savings, with the latest twelve files awaiting fresh-inventory reconciliation. The latest stop exposed a 7 ms heartbeat observation race at 61.09% commit; a focused correction preserves every limit and requires new source qualification before resuming. The 120 GiB newly reclaimed / 100 GiB free target remains open. [Item 325](../roadmap/items/item-325-tiered-data-retention-and-verified-archive-offload.md#production-pilot-and-resource-limited-expansion-september-8) owns exact bytes, receipts and resume requirements. |
