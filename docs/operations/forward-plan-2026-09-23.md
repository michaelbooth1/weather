...
9. **Live-path qualification kit** (mission 87a) adopted after RE-1, with PR 85's execution modules under their own roll
   verdict.
10. **Settlement hardening:** land the signed band parser ([item 333](../roadmap/items/item-333-signed-native-temperature-band-parser.md), minimal extraction of `016e1c92c`) before Toronto's first sub-zero high; add a
