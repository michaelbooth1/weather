...
| [nbm-target-period-contract.md](nbm-target-period-contract.md) | Parsing or replaying NBP maximum guidance, persisting token provenance, or admitting future guidance rows. |
