...
| Frozen residual reproduction and synthetic power planning | [Residual preflight](operations/residual-preflight.md) | Canonical research contract |
| **How the served model, training lanes, identity, and evaluation fit together** | [Weather model system](operations/MODEL_SYSTEM.md) | Canonical guide |
