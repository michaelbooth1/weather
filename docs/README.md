...
| First-landing control-plane probes and guarded installation | [Probe adapter](operations/BOOTSTRAP_QUALIFICATION_PROBES.md) and [guarded installation](operations/BOOTSTRAP_QUALIFICATION_INSTALLATION.md) | Source runbooks; separate owner envelope and host acceptance required |
