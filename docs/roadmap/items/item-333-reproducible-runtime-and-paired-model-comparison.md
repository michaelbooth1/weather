...
[item 334](item-334-post-reclaim-model-economics-and-research-plan.md) and signed
band correctness in [item 335](item-335-signed-native-temperature-band-correctness.md).
...
receipt and wider file scope are recorded in [item 334](item-334-post-reclaim-model-economics-and-research-plan.md#september-7-preparation-handback).
...
consumed by this slice. Item 334 records later READY/P3 integration and the
...
status, as linked from item 334. The `88bacc6` receipt retains
