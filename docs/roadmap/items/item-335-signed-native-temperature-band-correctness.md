# 335. Signed Native Temperature Band Correctness [PARTIAL 2026-09-07 - NATIVE VERIFIED; IMPACT AND ADOPTION OPEN]
...
combined `c11c3287`. Item 334 owns those source-bound receipt hashes.
The later full native suite passed at combined
`77092366f180177f561ac409f40161bd0586bdbe`. Item 334 owns the terminal receipt,
...
Publication and exact-tip Linux CI status are linked from item 334.
