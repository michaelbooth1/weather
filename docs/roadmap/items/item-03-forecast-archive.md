...
- [x] Start saving disabled paid-provider hourly forecast snapshots every 10 minutes.
...
- Continue saving disabled paid-provider and Open-Meteo hourly rows on every due snapshot.
...
disabled paid-provider, Open-Meteo, and ECCC, and
