# 252. Impossible Guidance Feature Quarantine [OPEN 2026-06-22 - GUIDANCE CAN BE FRESH BUT PHYSICALLY IMPOSSIBLE]
...
- [ ] Austin 2026-06-22 NBM probabilistic Tmax features are flagged as impossible before serving features are built.
- [ ] Guidance freshness reports distinguish timestamp freshness from physical validity.
- [ ] Training and serving paths handle impossible guidance consistently.
- [ ] Source-health reports show impossible-row counts and top affected features.
- [ ] Replay demonstrates that quarantining impossible guidance does not silently remove useful valid guidance rows.
