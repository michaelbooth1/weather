...
| Item | File |
| ---: | --- |
| 331 | [Post-Reclaim Model Economics And Research Plan [PARTIAL 2026-09-07 - APPROVED; SOURCE PREPARATION IN PROGRESS]](items/item-331-post-reclaim-model-economics-and-research-plan.md) |
| 332 | [Signed Native Temperature Band Correctness [PARTIAL 2026-09-07 - REPAIRED AND WORKSTATION-VERIFIED; ADOPTION OPEN]](items/item-332-signed-native-temperature-band-correctness.md) |
| 333 | [Reproducible Runtime And Paired Model Comparison [PARTIAL 2026-09-07 - INCUMBENT CONTROL PREPARED; VERIFICATION OPEN]](items/item-333-reproducible-runtime-and-paired-model-comparison.md) |
...
| 67 | [Authenticated Exchange Adapter And MM-2 Pilot Harness [PARTIAL 2026-09-06 - ATTENDED STAGE 0/1 PASSED; ECONOMIC PILOT OPEN]](items/item-67-authenticated-exchange-adapter-and-mm-2-pilot-harness.md) |
...
| 300 | [Current Exchange Economics And Rule-Drift Gate [COMPLETE 2026-08-15 - INTERNATIONAL PER-RUN SNAPSHOT BINDING INTEGRATED AND PROVEN]](items/item-300-current-exchange-economics-and-rule-drift-gate.md) |
...
| 309 | [Current Exchange-Economics Snapshot Production, Verification, And Accept-Baseline Workflow [PARTIAL 2026-08-19 - INTERNATIONAL V0.3/PUSD CONTRACT INTEGRATED; EXPLICIT ACCEPTANCE OPEN]](items/item-309-exchange-economics-snapshot-production-verification-and-accept-baseline.md) |
